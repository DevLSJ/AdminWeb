    ...
    <Box>
      ...
      <Card sx={{ overflow: 'hidden' }}>
        ...
        <TableContainer sx={{ maxHeight: 'calc(100vh - 350px)', minHeight: 360 }}>
          <Table stickyHeader size="small" className="dense-data-table" sx={{ minWidth: 880, '& .MuiTableCell-root': { px: 1.25, py: .72 }, '& .MuiTableCell-head': { py: .9, bgcolor: 'background.paper', fontSize: 12 } }}>
            <TableHead><TableRow><TableCell>제목</TableCell><TableCell>첨부</TableCell><TableCell>노출</TableCell><TableCell>작성자</TableCell><TableCell>등록일</TableCell><TableCell align="right">조회수</TableCell></TableRow></TableHead>
