  ...
  return (
    <Box className="notice-page" sx={{ width: '100%', maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      <Card className="section-card" sx={{ width: '100%', maxWidth: '100%', overflow: 'hidden', borderRadius: '2px !important' }}>
        ...
        <TableContainer sx={{ width: '100%', maxWidth: '100%', maxHeight: 'calc(100vh - 350px)', minHeight: 360, overflowX: 'auto' }}>
          <Table stickyHeader size="small" className="dense-data-table" sx={{ width: '100%', minWidth: 820, tableLayout: 'fixed', '& .MuiTableCell-root': { px: 1.25, py: .72, overflow: 'hidden' }, '& .MuiTableCell-head': { py: .9, bgcolor: 'background.paper', fontSize: 12 } }}>
