...
function CryptoTest() {
  ...
  return (
    <Box>
      <PageHeader title="암복호화 테스트" description="AES와 RSA 키의 상태별 실행 권한을 검증합니다. 재활성화 키는 암호화만, 비활성화 키는 복호화만 허용됩니다." />
