...
2026년 9월 1주차 UI 기준입니다. 이미지를 클릭하면 원본 크기로 확인할 수 있습니다.
...
`/settings`에서 공통코드와 신규 키 기본 유효기간·만료 알림일을 관리합니다. 기존 기본값은 365일/30일이며 S.ADMIN만 변경할 수 있습니다. 키 목록의 만료 임박 행 강조·폐기 아이콘·현재 월 등록 달력과 검증/시연 절차는 [운영 정책 관리 안내](docs/KEY_SETTINGS.md)를 참고하세요.
